      ...
      <CRow>
        <CCol sm="12" md="5">
          <CCard accentColor="primary">
            <CCardHeader>Network Scan</CCardHeader>
            <CCardBody>
              <CForm
                action=""
                method="post"
                    ...
                    <CRow>
                      <CCol>
                        <CInput
                          id="text-input"
                          name="text-input"
                          placeholder={port_from}
                          onChange={handlePortFrom}
                        />
                      </CCol>
                      _
                      <CCol>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="3">
                    <CInput
                      ...
                      placeholder={scan_rate}
                      onChange={handleScanRate}
                    />
                  </CCol>
                </CFormGroup>
                <CFormGroup row>
            ...
            <CCardBody style={{ height: "600px", overflow: "auto" }}>
              <CCollapse show={collapseMulti[0]}>
                <CFade timeout={300} in={collapseMulti[0]}>
                  ...
                  <CCollapse show={col1} style={{ marginLeft: "30px" }}>
                    {whois_results.domain_name &&
                      whois_results.domain_name.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col2} style={{ marginLeft: "30px" }}>
                    {whois_results.registrar &&
                      whois_results.registrar.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col3} style={{ marginLeft: "30px" }}>
                    {whois_results.whois_server &&
                      whois_results.whois_server.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col4} style={{ marginLeft: "30px" }}>
                    {whois_results.referral_url &&
                      whois_results.referral_url.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col5} style={{ marginLeft: "30px" }}>
                    {whois_results.updated_date &&
                      whois_results.updated_date.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col6} style={{ marginLeft: "30px" }}>
                    {whois_results.creation_date &&
                      whois_results.creation_date.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col7} style={{ marginLeft: "30px" }}>
                    {whois_results.expiration_date &&
                      whois_results.expiration_date.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col8} style={{ marginLeft: "30px" }}>
                    {whois_results.name_servers &&
                      whois_results.name_servers.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col9} style={{ marginLeft: "30px" }}>
                    {whois_results.status &&
                      whois_results.status.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col10} style={{ marginLeft: "30px" }}>
                    {whois_results.emails &&
                      whois_results.emails.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col11} style={{ marginLeft: "30px" }}>
                    {whois_results.dnssec &&
                      whois_results.dnssec.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col12} style={{ marginLeft: "30px" }}>
                    {whois_results.name &&
                      whois_results.name.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col13} style={{ marginLeft: "30px" }}>
                    {whois_results.org &&
                      whois_results.org.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col14} style={{ marginLeft: "30px" }}>
                    {whois_results.address &&
                      whois_results.address.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col15} style={{ marginLeft: "30px" }}>
                    {whois_results.city &&
                      whois_results.city.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col16} style={{ marginLeft: "30px" }}>
                    {whois_results.state &&
                      whois_results.state.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col17} style={{ marginLeft: "30px" }}>
                    {whois_results.zipcode &&
                      whois_results.zipcode.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
                  ...
                  <CCollapse show={col18} style={{ marginLeft: "30px" }}>
                    {whois_results.country &&
                      whois_results.country.map((item, idx) => (
                        <li key={idx}>{item}</li>
                      ))}
                  </CCollapse>
                  <hr style={{ width: "100%" }} />
              ...
              <CCollapse show={collapseMulti[1]}>
                <CFade timeout={300} in={collapseMulti[1]}>
                  {robot_results.txt === "" ? (
                    <p>No Robots.txt on {robot_results.target}</p>
                  ) : (
