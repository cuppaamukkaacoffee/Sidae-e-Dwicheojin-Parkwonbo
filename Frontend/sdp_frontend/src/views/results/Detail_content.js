...
export const xss_web_reference = [
    {name:'The Cross Site Scripting Faq', link:'http://www.cgisecurity.com/xss-faq.html'},
    {name:'OWASP Cross Site Scripting', link:'http://www.owasp.org/index.php/Cross_Site_Scripting'},
    {name:'XSS Filter Evasion Cheat Sheet', link:'https://www.owasp.org/index.php/XSS_Filter_Evasion_Cheat_Sheet'},
    {name:'Cross site scripting', link:'http://en.wikipedia.org/wiki/Cross-site_scripting'},
    {name:'OWASP Top Ten', link:'https://owasp.org/www-project-top-ten/'},
    {name:'How To: Prevent Cross-Site Scripting in ASP.NET', link:'http://msdn.microsoft.com/en-us/library/ms998274.aspx'},
]

export const sql_web_reference = [
    {name:'The SQL Injection Faq', link:'https://www.sqlsecurity.com/faqs-1/sql-injection-faq'},
    {name:'OWASP SQL Injection', link:'https://owasp.org/www-community/attacks/SQL_Injection'},
    {name:'SQL Injection', link:'https://en.wikipedia.org/wiki/SQL_injection'},
    {name:'OWASP Top Ten', link:'https://owasp.org/www-project-top-ten/'},
]
