...
import { CBadge, CDataTable, CButton, CLink } from "@coreui/react";
...
const fields = [
  ...
  "sqli",
  "open_redirect",
  "windows_directory_traversal",
  "linux_directory_traversal",
  "lfi",
  "rfi",
  "rce_linux",
  "rce_php",
          ...
          windows_directory_traversal: (item) => (
            <td>
              <CButton
                ...
                disabled={!item.windows_directory_traversal}
              >
                <CBadge shape="pill" color="primary">
                  {item.windows_directory_traversal}
                </CBadge>
              </CButton>
            </td>
          ),
          linux_directory_traversal: (item) => (
            <td>
              <CButton
                ...
                disabled={!item.linux_directory_traversal}
              >
                <CBadge shape="pill" color="secondary">
                  {item.linux_directory_traversal}
                </CBadge>
              </CButton>
            </td>
          ),
