...
const Net_result = () => {
    ...
    const handleRowclick = (e) =>{
        ...
        dispatch(userActions.net_results_check({username: e.username, scan_session_id : e.scan_session_id}));
    }
                ...
                <CCol xs="12" md="5">
                    <CCard>
                        ...
                        <CCardFooter>
                            ...
                            {loading && <CSpinner color="primary" style={{width:'1.5rem', height:'1.5rem',marginLeft:'10px',marginRight:'10px'}}/>}  
                            {errorMsg}
                        </CCardFooter>
                    </CCard>
                    <CCard>
                        ...
                        <CCardBody style={{height:"650px",overflow: 'auto'}}> 
                            <CCollapse show={collapseMulti[0]}>
                                <CFade timeout ={300} in ={collapseMulti[0]}>
                                    ...
                                    <CCollapse show={col1} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.domain_name.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col2} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.registrar.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col3} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.whois_server.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col4} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.referral_url.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col5} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.updated_date.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col6} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.creation_date.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col7} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.expiration_date.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col8} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.name_servers.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col9} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.status.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col10} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.emails.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col11} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.dnssec.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col12} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.name.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col13} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.org.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col14} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.address.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col15} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.city.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col16} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.state.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                    ...
                                    <CCollapse show={col18} style={{marginLeft:'30px'}}>
                                        {net_results.whois && net_results.whois.country.map((item,idx)=> <li key = {idx}>{item}</li>)}
                                    </CCollapse>
                                    <hr style={{width:"100%"}}/>
                                </CFade>
                            </CCollapse>
                            ...
                            <CCollapse show={collapseMulti[2]}>
                                <CFade timeout ={300} in ={collapseMulti[2]}>
                                    <h4>IP Address</h4>
                                    {net_results.ips && net_results.ips.map((item,idx) => (
                                        <CListGroupItem key={idx}>{item.ip_address}</CListGroupItem>
                                    ))}
                                    <br/>
                                    <h4>Open Ports</h4>
                                    <CDataTable
