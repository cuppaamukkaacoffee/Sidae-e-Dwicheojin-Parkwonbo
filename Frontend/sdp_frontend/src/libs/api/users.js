...
export const results_api = async (info) => {
  ...
  const response = await axios.post("/scan/query/", JSON.stringify(data), {
    headers: {
...
export const net_targets_api = async (info) => {
  ...
  const response = await axios.post("/netscan/target/", JSON.stringify(data), {
    headers: {
      "Content-Type": `application/json`,
      Authorization: `Token ${token}`,
    },
...
export const net_results_api = async (info) => {
  ...
  const response = await axios.post("/netscan/result/", JSON.stringify(data), {
    headers: {
      "Content-Type": `application/json`,
      Authorization: `Token ${token}`,
    },
