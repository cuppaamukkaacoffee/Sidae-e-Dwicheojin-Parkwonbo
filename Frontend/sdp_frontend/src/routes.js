...
const routes = [
  ...
  { path: '/webresult', exact: true, name: 'Web Scan Results', component: Web_result },
  { path: '/netresult', exact: true, name: 'Network Scan Results', component: Net_result },
  ...
  { path: '/webdetail', exact: true, name: 'Web Scan Detail', component: Web_detail },
  { path: '/netdetail', exact: true, name: 'Network Scan Detail', component: Net_detail },
];
